...
const propTypes = {
  ...
  /**
   * Callback that is called after the map is cached to an Image.
   */
...
class MapView extends React.Component {
  constructor(props) {
    ...
    this._onCache = this._onCache.bind(this);
  }
  ...
  _onCache(e) {
    this.props.onCache && this.props.onCache(e.nativeEvent.data);
  }
